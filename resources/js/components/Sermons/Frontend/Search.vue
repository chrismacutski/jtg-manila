                ...
                <div class="form-group">
                    <div class="form-row">
                        ...
                        <div class="col-md col-lg align-self-end">
                            <button :disabled="disableFindEventButton" type="submit" class="btn btn-primary form-control" v-html="findSermonButtonText"></button>
                        </div>
                    </div>
                </div>
            </form>
    ...
    export default {
        ...
        data() {
            return {
                ...
                findSermonButtonText: 'FIND MESSAGES',
        ...
        computed: {
            disableFindEventButton() {
                if (this.findSermonButtonText == 'FIND MESSAGES') {
                    return false;
                }
        ...
        methods: {
            load() {
                this.filters.take = 9;
                this.$emit('hide-list');
                this.findSermonButtonText = '<i class="fa fa-spinner fa-spin fa-lg fa-fw"></i>';
            ...
            filter: _.debounce(function() {
                axios.post('/sermons/filter', this.filters)
                    .then(({data}) => {
                        ...
                        this.findSermonButtonText = 'FIND MESSAGES';
